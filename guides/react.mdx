...
description: Learn how to use React with Nhost
sidebarTitle: React
---
        ...
        <form onSubmit={handleSignIn}>
          ...
          <div>
            <button disabled={loading}>
              {loading ? <span>Loading</span> : <span>Sign In with a Magic Link</span>}
            </button>
          </div>
...
export default function Todos() {
  ...
  const handleCreateTodo = async (e) => {
    ...
    if (todoFile) {
      const { id, isError } = await upload({ file: todoFile, name: todoFile.name })
  ...
  const openAttachment = async (todo) => {
    ...
    nhostClient.storage.getPresignedUrl()
        ...
        <div className="form-section">
          ...
          <form onSubmit={handleCreateTodo}>
            ...
            <div className="input-group">
              ...
              <input type="file" onChange={(e) => setTodoFile(e.target.files[0])} />
            </div>
